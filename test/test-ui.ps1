...
if ($Commands.Count -gt 0 -or $ExpectedOutputs.Count -gt 0) {
    ...
    $cases = @(
        ...
        @{ Name = 'empty list'; Commands = @('list', 'bye'); ExpectedOutputs = @("$welcome`n$divider`nHere are the tasks in your list:`nYour task list is empty. Available commands: bye, list, todo, deadline, event, mark, unmark.`n$divider`n$exitMessage") },
        ...
        @{ Name = 'unrecognised command'; Commands = @('buy groceries today', 'list', 'bye'); ExpectedOutputs = @("$welcome`n$divider`nUnknown command 'buy'. Available commands: bye, list, todo, deadline, event, mark, unmark.`n$divider`n$divider`nHere are the tasks in your list:`nYour task list is empty. Available commands: bye, list, todo, deadline, event, mark, unmark.`n$divider`n$exitMessage") },
        ...
        @{ Name = 'argument-free commands reject extra text'; Commands = @('list now', 'bye now', 'list', 'bye'); ExpectedOutputs = @("$welcome`n$divider`nThe 'list' command does not accept arguments. Enter only 'list'.`n$divider`n$divider`nThe 'bye' command does not accept arguments. Enter only 'bye'.`n$divider`n$divider`nHere are the tasks in your list:`nYour task list is empty. Available commands: bye, list, todo, deadline, event, mark, unmark.`n$divider`n$exitMessage") },
